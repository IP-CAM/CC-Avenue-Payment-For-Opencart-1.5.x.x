...
<div id="content">
  ...
  <div class="box" >
    ...
    <div class="content">
		<div>
			<a href="https://www.winlineindia.com/" target="_blank">
			<img src="view/image/payment/logo.png" alt="WinLine India Logo" />
			Ccavenue Payment Module developed by WinLine India
			</a>
		</div>
